...
public final class HttpClientApp {
    ...
    static void runGeneralExample() {
        ...
        var request = newBuilder()
                ...
                .headers("SRI", "Developer", "Author", "Srikanth Kakumanu")
    ...
    /**
     * Example of Asynchronous communication of multiple requests
     * @throws URISyntaxException
     */
    ...
    static void post(String uri, String data) throws Exception {
        ...
        System.out.println("Status code: ".concat(valueOf(response.statusCode())));
    }
